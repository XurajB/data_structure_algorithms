...
/******************************************************************************
 *  Compilation:  javac MyBinarySearchTree.java
 *  Execution:    java MyBinarySearchTree
 ...
 *
 *  % java MyBinarySearchTree < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
 ...
 *
 **
 *  The {@code MyBinarySearchTree} class represents an ordered symbol table of generic
 *  key-value pairs.
...
public class MyBinarySearchTree<Key extends Comparable<Key>, Value> {
    private Node root;             // root of MyBinarySearchTree
    ...
    // return number of key-value pairs in MyBinarySearchTree rooted at x
    ...
    /**
     * Returns the height of the MyBinarySearchTree (for debugging).
     *
     * @return the height of the MyBinarySearchTree (a 1-node tree has height 0)
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Returns the keys in the MyBinarySearchTree in level order (for debugging).
     *
     * @return the keys in the MyBinarySearchTree in level order traversal
     */
    ...
    /*************************************************************************
     * Check integrity of MyBinarySearchTree data structure.
     ***************************************************************************/
    ...
    // is the tree rooted at x a MyBinarySearchTree with all keys strictly between min and max
